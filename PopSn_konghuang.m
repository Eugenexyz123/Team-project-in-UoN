function  [Pop_S,Pop,Env_S,Pop_Snext]=PopSn_konghuang(Pop_S,Pop,ZAM,Env_S,Dst_S,Wid,Len,L_cell,Exit_S,...
...
%     [K,I]=min(A);%找出口I；
[m,n]=size(Exit_S);% 出口长宽
I= randperm(m,1) ;%随机出去，不一定是最近出口
    yidong=rand(1);
    if yidong>0.5
